---
title: "Symmetry of Consciousness"
...
Such an unchanging null state seems in ways similar to an [identity element](https://en.wikipedia.org/wiki/Identity_element).

Are all conscious experiences symmetric? Like how you may consider different [permutations of a Rubik's cube](https://en.wikipedia.org/wiki/Rubik's_Cube_group) to be symmetric despite the labels not matching?

---

Would this mean [Lie Theory](https://en.wikipedia.org/wiki/Lie_theory), the study of continuous symmetries, can be applied to our continuous experience from birth to death?
